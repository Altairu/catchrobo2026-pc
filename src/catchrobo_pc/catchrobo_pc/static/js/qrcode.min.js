/**
 * QRCode.js (Lightweight standalone edition for offline WebGUI)
 */
var QRCode;
(function () {
	...
	QRCode.prototype.makeCode = function (sText) {
		this._el.innerHTML = "";
		var oQRCode = new QRCodeModel(-1, this._htOption.correctLevel);
